...
message = tk.Label(window, text="Face Recognition Attendance System" ,bg="gray"  ,fg="white"  ,width=50  ,height=3,font=('times', 50, 'bold underline')) 

message.place(x=130, y=20)
...
message2 = tk.Label(window, text="" ,fg="red"   ,bg="yellow",activeforeground = "green",width=50  ,height=2  ,font=('times', 15, ' bold ')) 
message2.place(x=700, y=650)

devl=tk.Label(window,text="DEVELOPED BY" ,bg="grey"  ,fg="white"  ,width=50  ,height=2,font=('times', 30, 'italic bold '))
devl.place(x=900,y=850)

cmpny=tk.Label(window,text="QUIK TECH SOFTWARES" ,bg="gray"  ,fg="white"  ,width=50  ,height=2,font=('times', 30, 'italic bold underline'))
cmpny.place(x=900,y=950)
...
copyWrite.tag_configure("superscript", offset=20)
copyWrite.insert("insert", "QUIK TECH SOFTWARES","", "", "superscript")
copyWrite.configure(state="normal",fg="red"  )
copyWrite.pack(side="bottom")
copyWrite.place(x=600, y=1000)
 """
window.mainloop()